...
void lcd_HomePage(int day,int date,int month,int year,int hour,int minute,int second, int temperature, int power){
	...
	switch(day){
		case 1: 
			lcd_puts(1,6,(int8_t*)"Mon");
			break;
		case 2: 
			lcd_puts(1,6,(int8_t*)"TUE");
			break;
		case 3: 
			lcd_puts(1,6,(int8_t*)"WED");
			break;
		case 4: 
			lcd_puts(1,6,(int8_t*)"THU");
			break;
		case 5: 
			lcd_puts(1,6,(int8_t*)"FRI");
			break;
		case 6: 
			lcd_puts(1,6,(int8_t*)"SAT");
			break;
		case 7: 
			lcd_puts(1,6,(int8_t*)"SUN");
			break;
	}
	switch(month){
		case 1: 
			lcd_puts(1,10,(int8_t*)"Jan");
			break;
		case 2: 
			lcd_puts(1,10,(int8_t*)"Feb");
			break;
		case 3: 
			lcd_puts(1,10,(int8_t*)"Mar");
			break;
		case 4: 
			lcd_puts(1,10,(int8_t*)"Apr");
			break;
		case 5: 
			lcd_puts(1,10,(int8_t*)"May");
			break;
		case 6: 
			lcd_puts(1,10,(int8_t*)"Jun");
			break;
		case 7: 
			lcd_puts(1,10,(int8_t*)"Jul");
			break;
		case 8: 
			lcd_puts(1,10,(int8_t*)"Aug");
			break;
		case 9: 
			lcd_puts(1,10,(int8_t*)"Sep");
			break;
		case 10: 
			lcd_puts(1,10,(int8_t*)"Oct");
			break;
		case 11: 
			lcd_puts(1,10,(int8_t*)"Nov");
			break;
		case 12: 
			lcd_puts(1,10,(int8_t*)"Dec");
			break;
	}
	sprintf(lcd_buffer,"%d",date);
	if(date<10){
		lcd_puts(1,13,(int8_t*)"0");
		lcd_puts(1,14,(int8_t*)lcd_buffer);
	}
	else{
		lcd_puts(1,13,(int8_t*)lcd_buffer);
	}
	lcd_puts(1,0,(int8_t*)"Date:");
	lcd_puts(1,9,(int8_t*)",");
	lcd_puts(1,15,(int8_t*)",2017");
	
	//time
	lcd_puts(2,0,(int8_t*)"Time:");
	sprintf(lcd_buffer,"%d",hour);
	if(hour<10){
		lcd_puts(2,6,(int8_t*)"0");
		lcd_puts(2,7,(int8_t*)lcd_buffer);
	}
	else{
		lcd_puts(2,6,(int8_t*)lcd_buffer);
	}
	lcd_puts(2,8,(int8_t*)":");
	sprintf(lcd_buffer,"%d",minute);
	if(minute<10){
		lcd_puts(2,9,(int8_t*)"0");
		lcd_puts(2,10,(int8_t*)lcd_buffer);
	}
	else{
